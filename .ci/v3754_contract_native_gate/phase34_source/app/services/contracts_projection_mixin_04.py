...
class ContractServiceMixin4:
        ...
        async def record_item_delivery(self, guild_id: int, contract_id: int, actor_id: int, *, event_key: str, item_id: str, quantity: int) -> bool:
            return await self._record_verified_event(
                guild_id, contract_id, actor_id, event_key=event_key, event_type="item_delivered",
                target_ref=str(item_id), delta=quantity,
                payload={"item_id": str(item_id), "quantity": int(quantity)},
            )
        ...
        async def record_business_delivery(self, guild_id: int, contract_id: int, actor_id: int, *, event_key: str, business_ref: str, quantity: int = 1) -> bool:
            return await self._record_verified_event(
                guild_id, contract_id, actor_id, event_key=event_key,
                event_type="business_delivery_completed", target_ref=business_ref, delta=quantity,
            )

        async def record_vehicle_service(self, guild_id: int, contract_id: int, actor_id: int, *, event_key: str, service_ref: str) -> bool:
            return await self._record_verified_event(
                guild_id, contract_id, actor_id, event_key=event_key,
                event_type="vehicle_service_completed", target_ref=service_ref,
            )

        async def record_contribution(self, guild_id: int, contract_id: int, actor_id: int, *, event_key: str, contribution_ref: str, amount: int) -> bool:
            return await self._record_verified_event(
                guild_id, contract_id, actor_id, event_key=event_key,
                event_type="contribution_recorded", target_ref=contribution_ref, delta=amount,
            )

        async def record_system_participation(self, guild_id: int, contract_id: int, actor_id: int, *, event_key: str, participation_ref: str) -> bool:
            return await self._record_verified_event(
                guild_id, contract_id, actor_id, event_key=event_key,
                event_type="system_participation", target_ref=participation_ref,
            )
