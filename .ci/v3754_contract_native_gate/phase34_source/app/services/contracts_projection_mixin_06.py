        ...
        async def recover_ready_contracts(self, guild_id: int) -> int:
            ...
            for contract_id in contract_ids:
                try:
                    ...
                    # A concurrent maintenance path may have already moved the
                    # contract to a terminal state. Re-read and only ignore that
                    # benign race; real active corruption remains visible.
