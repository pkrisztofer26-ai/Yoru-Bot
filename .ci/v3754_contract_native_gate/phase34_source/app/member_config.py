...
WELCOME_DEFAULT_DM_TEMPLATE = (
    "Szia {username}! 👋 Üdv a **{server}** szerveren. "
    "A Yoru egy karakterközpontú gazdasági játék; az alábbi három lépéssel rögtön el tudsz indulni."
)
