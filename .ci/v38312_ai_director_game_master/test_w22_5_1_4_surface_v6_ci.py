...
def test_npc_awkward_relation_van_phrase_rejected():
    p = npc_story_packet(npc_name='Zoli',npc_role='kapcsolattartó',relationship_band='óvatos',recalled_event='korábban betartottad a megállapodást',current_story_state='újra szóba áll veled')
    with pytest.raises(AIDirectorGameMasterValidationError):
        validate_game_master_surface(p, {'title':'Zoli emlékszik','description':'Zoli, a kapcsolattartó óvatos hangulatban van veled. Felidézte, hogy korábban betartottad a megállapodást. Jelenleg újra szóba áll veled.'})

def test_npc_role_fragment_rejected():
    p = npc_story_packet(npc_name='Mira',npc_role='informátor',relationship_band='bizalmatlan',recalled_event='egy régi ügyben cserben hagytad',current_story_state='távolságot tart')
    with pytest.raises(AIDirectorGameMasterValidationError):
        validate_game_master_surface(p, {'title':'Mira emlékszik','description':'Mira, informátor. A kapcsolat jelenlegi hangulata: bizalmatlan. Felidézett esemény: egy régi ügyben cserben hagytad. Jelenlegi történeti helyzet: távolságot tart.'})
