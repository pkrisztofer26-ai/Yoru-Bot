...
FIXTURE_PARTS = tuple(sorted(HERE.glob("fixture.fast*.b64")))
...
def main() -> int:
    ...
    if len(FIXTURE_PARTS) != 13:
        raise SystemExit(f"W12.2 fixture part count mismatch: {len(FIXTURE_PARTS)} != 13")
    ...
    print(f"W12.2 FAST/RESUME fixture PASS text_sha256={text_sha} archive_sha256={actual} chunks={len(FIXTURE_PARTS)}")
    return 0
